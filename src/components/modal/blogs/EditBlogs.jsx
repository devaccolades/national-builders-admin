...
import { BlogsEditSchema } from '../../../Validations/Validations';
...
function EditBlogs({isModal, setModal, fetchData, editData}) {
  const [isLoading, setLoading] = useState(false)
    ...
    const {
        ...
        validationSchema: BlogsEditSchema,
  ...
  const DeleteBlog = async () => {
    Swal.fire({
      title: `Do you want to delete the "${editData?.title}" blog?`,
