...
import { TestimoniealsAddSchema } from '../../../Validations/Validations';
import Swal from 'sweetalert2';
import { AddTestimoniealsApi} from '../../../services/services';

function AddTestimonieals({ isModal, setModal, fetchData,projecDropDowntData }) {
    ...
    const {
        ...
        validationSchema: TestimoniealsAddSchema,
        onSubmit: async (values, { setSubmitting }) => {
            ...
            formData.append('description', values.description);
              try {
                const res = await AddTestimoniealsApi(formData)
    ...
    return (
        <Container className={isModal && "active"}>
            ...
            <Modal>
                <div>
                    <Heding>Add Testimonieals</Heding>
...
export default AddTestimonieals
