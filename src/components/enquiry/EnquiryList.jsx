...
function EnquiryList() {
    ...
    return (
        <TableSection>
                    ...
                    <Tbody>
                        {data.map((enquiry, index) => (
                            <Tr>
                                ...
                                <Td is_read={enquiry.is_read}>{enquiry?.project?.name || "Not Provided"}</Td>
            ...
            {showData && <EnquiryModal isModal={isModal} setModal={setModal} showData={showData} is_rental={false}/>}
        </TableSection>
    )
}
